...
namespace ClassicUO.Configuration
{
    ...
    public class ModernOptionsGumpLanguage
    {
        ...
        public class Video
        {
            ...
            public string ShadowMode { get; set; } = "Shadow model";
            public string ShadowClassic { get; set; } = "Classic";
            public string ShadowDynamic { get; set; } = "Dynamic day/night/weather";
            public string EnhancedObjectShadows { get; set; } = "Enhanced object shadows";
            public string ShadowIntensity { get; set; } = "Maximum shadow intensity";
            public string ShadowLength { get; set; } = "Shadow projection length";
            public string AmbienceIntensity { get; set; } = "Day/night ambience intensity";
            #endregion
        }
