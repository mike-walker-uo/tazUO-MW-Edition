...
public class BaseOptionsGump : Gump
{
    ...
    {
        ColorBox background = new ColorBox(Width, Height, ThemeSettings.BACKGROUND)
        {
        ...
        ColorBox header = new ColorBox(Width, 40, ThemeSettings.SEARCH_BACKGROUND)
        {
            AcceptMouseInput = true,
            CanMove = true,
            Alpha = 0.85f
    ...
    public class LeftSideMenuRightSideContent : Control
    {
        ...
        public LeftSideMenuRightSideContent(int width, int height, int leftWidth, int page = 0)
        {
            ...
            var menuBackground = new AlphaBlendControl()
            {
                Width = leftWidth,
                Height = Height,
                CanMove = true
            };
            CustomGumpThemeManager.ApplyDataSurface(menuBackground, menuBackground.Alpha);
            Add(menuBackground, page);
    ...
    protected class HotkeyBox : Control
    {
        ...
        public HotkeyBox()
        {
            ...
            CustomGumpThemeManager.ApplyInputSurface(bg, bg.Alpha);
    ...
    public class InputField : Control
    {
        ...
        public InputField(int width, int height, int maxWidthText = 0, int maxCharsCount = -1, string text = "", bool numbersOnly = false, EventHandler onTextChanges = null)
        {
            ...
            CustomGumpThemeManager.ApplyInputSurface(_background, _background.Alpha);
