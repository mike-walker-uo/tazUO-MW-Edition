...
namespace ClassicUO.Game.Managers
{
    public static class CommandMetadata
    {
            ...
            new Dictionary<string, Entry>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "gumpopacity",    new Entry { Category="UI", Description="Set a gump opacity option. All: 0-100 (utility/chat min 20, hover unchanged).", Usage="<all|custom|durability|container|corpse|gridborder|journal|buff|slayer|hovermin> <percent> | <altscroll|hoverboost> [on|off|toggle]" } },
            { "gumpopacityall",        new Entry { Category="UI", Description="Set all supported gump opacity values; utility/chat min 20, hover unchanged.", Usage="<0-100>" } },
